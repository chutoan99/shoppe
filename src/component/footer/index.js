          ...
          <div className="col l-2-4 mo-3 c-6">
            ...
            <div className="footer-download">
              ...
              <div className="footer-download-app">
                <a href="# " className="footer-download-link">
                  <img src={IMG.GOOGLE} className="footer-download-app-img" alt="" />
                </a>
                <a href="# " className="footer-download-link">
                  <img src={IMG.APPSTORE} className="footer-download-app-img" alt="" />
                </a>
                <a href="# " className="footer-download-link">
                  <img src={IMG.GALLERY} className="footer-download-app-img" alt="" />
                </a>
              </div>
            </div>
          </div>
