...
function PaymentMethods() {
  ...
  const handelChangeVariation = (item: any, index: any) => {
    setVariation(item);
    if (index === 0) {
      setBanners(true);
    } else {
                      ...
                      <div className="stardust-radio__label">
                        <div className="checkout-bank-transfer-item__card">
                          <div className="checkout-bank-transfer-item__icon-container">
                            <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg//assets/37110bc844b571f80e7dd14beb5415e9.png" className="checkout-bank-transfer-item__icon" alt="" />
                          </div>
                  ...
                  >
                    ...
                    <div className="stardust-radio__content">
                      <div className="stardust-radio__label">
                        <div className="checkout-bank-transfer-item__card">
                          <div className="checkout-bank-transfer-item__icon-container">
                            <img src="https://static.v2.airpay.vn/admin/channelIcon/images_v101/c134/icon_c13403_t1610003677268.png" className="checkout-bank-transfer-item__icon" alt="" />
                          </div>
                          <div className="checkout-bank-transfer-item__main">
