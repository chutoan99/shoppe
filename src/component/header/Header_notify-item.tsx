    ...
    <li className="Header_notify-item Header_notify-item--viewed">
      <a href="# " className="Header_notify-link">
        ...
        <div className="Header_notify-infor">
          ...
          <span className="Header_notify-description">Mắt kính, trang sức, quần áo từ 69k, Đồng hồ phụ kiện công nghệ từ 90k, Có thêm quà tặng kèm hấp dẫn, Deal xịn giá rẻ-Sắm ngay!</span>
        </div>
      </a>
    </li>
  );
}
export default memo(HeaderNotifyItem);
